        ...
        <Card.Body className="p-0">
          ...
          <div className="card-img-top border-bottom border-block-end-dashed">
            <div className="btns-container-1 align-items-center gap-1">
              <SpkTooltips placement="top" title="Quick View">
                <Link scroll={false} href="#!" className="btn btn-icon btn-primary rounded-circle">
                  <i className="bx bx-search"></i>
                </Link>
              </SpkTooltips>
              <SpkTooltips placement="top" title="Add to Wishlist">
                <Link href="/apps/ecommerce/wishlist" onClick={onclick} className="btn btn-icon btn-primary1 rounded-circle">
                  <i className="bx bx-heart align-center"></i>
                </Link>
              </SpkTooltips>
              <SpkTooltips placement="top" title="Compare">
                <Link scroll={false} href="#!" className="btn btn-icon btn-info rounded-circle">
            ...
            <SpkTooltips placement="top" title="Add to Cart">
              <Link href="/apps/ecommerce/cart" onClick={cartClick} className="btn btn-primary rounded-circle btn-style-1 btn-icon">
          ...
          <div className="p-3">
            <h6 className="mb-1 fw-semibold fs-16">
              <Link scroll={false} href={idx} onClick={detailsClick}>
                {card.title}
              </Link>
            </h6>
            <div className="d-flex align-items-end justify-content-between flex-wrap">
              <div className="flex-grow-1">
                ...
                <Link scroll={false} href="#!" className="text-primary1 fs-13 fw-semibold">
                  {card.status}
                </Link>
              </div>
              <div className="min-w-fit-content">
