...
const Spkcardscomponent: React.FC<SpkcardscomponentProps> = ({ card, cardClass, Icon, svgIcon, mainClass, parentClass, dataClass, badgeClass, headingClass, badgeColor, iconClass }) => {
