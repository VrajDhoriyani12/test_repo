...
const avatar1 = <div className="avatar-list-stacked">
    ...
    <Link scroll={false} className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" href="#!">+5</Link>
</div>
...
const avatar3 = <div className="avatar-list-stacked">
    ...
    <Link scroll={false} className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" href="#!">+2</Link>
</div>
...
const Avatar = <div className="avatar-list-stacked">
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/2.jpg" alt="img" /></span>
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/8.jpg" alt="img" /></span>
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/2.jpg" alt="img" /></span>
    <Link scroll={false} className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" href="#!">+4</Link>
</div>

const Avatar1 = <div className="avatar-list-stacked">
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/1.jpg" alt="img" /></span>
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/5.jpg" alt="img" /></span>
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/11.jpg" alt="img" /></span>
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/15.jpg" alt="img" /></span>
    <Link scroll={false} className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" href="#!">+4</Link></div>

const Avatar2 = <div className="avatar-list-stacked">
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/6.jpg" alt="img" /></span>
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/16.jpg" alt="img" /></span>
    <Link scroll={false} className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" href="#!">+10</Link>
</div>

const Avatar3 = <div className="avatar-list-stacked">
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/3.jpg" alt="img" /></span>
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/10.jpg" alt="img" /></span>
    <span className="avatar avatar-sm avatar-rounded"><img src="../../assets/images/faces/14.jpg" alt="img" /></span>
    <Link scroll={false} className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" href="#!">+6</Link>
</div>
