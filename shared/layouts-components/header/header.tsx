      ...
      <header className="app-header sticky" id="header">
        ...
        <div className="main-header-container container-fluid">
          ...
          <ul className="header-content-right">
            ...
            <SpkDropdown Customclass="header-element cart-dropdown" toggleas="a" Navigate='#!' Svg={true} Customtoggleclass='header-link dropdown-toggle no-caret' Badgetag={true} Badgeclass='header-icon-badge' Menuclass='main-header-dropdown dropdown-menu-end'
