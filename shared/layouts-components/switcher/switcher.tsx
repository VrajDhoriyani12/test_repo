                ...
                <Tab.Container defaultActiveKey="home">
                    ...
                    <div className="offcanvas-body">
                                        ...
                                        <Col sm={6}>
                                            <div className="form-check switch-select">
                                                ...
                                                {/* <input className="form-check-input" type="radio" name="sidemenu-layout-styles"
                                                    id="switcher-default-menu" onChange={(_e) => { }} checked={local_varaiable.dataVerticalStyle == "overlay"} onClick={() => switcherdata.Defaultmenu(ThemeChanger)} /> */}
                                                <input className="form-check-input" type="radio" name="sidemenu-layout-styles"
                        ...
                        <div className="d-flex justify-content-between canvas-footer flex-nowrap gap-2">
                            <Link scroll={false} href="https://themeforest.net/user/spruko/portfolio" target="_blank" className="btn btn-primary m-1 text-nowrap">Buy Now</Link>
                            <Link scroll={false} href="https://themeforest.net/user/spruko/portfolio" target="_blank" className="btn btn-secondary m-1 text-nowrap">Our Portfolio</Link>
                            <Link scroll={false} href="#!" id="reset-all" className="btn btn-danger m-1 text-nowrap" onClick={() => switcherdata.Reset(ThemeChanger)}>Reset</Link>
                        </div>
                    </div>
                </Tab.Container>
            </div>
