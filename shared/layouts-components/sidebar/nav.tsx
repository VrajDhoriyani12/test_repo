...
export const MENUITEMS: any = [
  {
    title: 'Broadcasting', icon: Dashboardicon, type: "sub", active: false, children: [
      // { path: '/broadcasting/whatsapp-broadcast', type: "link", active: false, selected: false, title: 'WhatsApp Broadcast' },
      {
        path: "/broadcasting/whatsapp-broadcast",
        type: "link",
        active: false,
        selected: false,
      ...
      {
        path: "/broadcasting/whatsapp-template",
        type: "link",
        active: false,
        selected: false,
      ...
      {
        path: "/broadcasting/whatsapp-campaign",
        type: "link",
        active: false,
        selected: false,
      ...
      {
        path: "/broadcasting/sms-broadcast",
        type: "link",
        active: false,
        selected: false,
        title: "SMS Broadcast",
  ...
  {
    title: 'Master', icon: Appsicon, type: "sub", active: false, children: [
      {
