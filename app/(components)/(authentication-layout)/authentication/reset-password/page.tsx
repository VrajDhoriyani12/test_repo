"use client"
import { resetPasswordApi, validateNoWhiteSpace } from "@/app/(components)/Configs/Utils/APIs/Admin_Apis";
...
const Basic = () => {
    ...
    const onsubmit = async (data: any) => {
        ...
        const response = await resetPasswordApi('token', body)
                                    ...
                                    <Form onSubmit={handleSubmit(onsubmit)}>
                                        <div className="row gy-3">
                                            ...
                                            <Col xl={12}>
                                                ...
                                                <div className='position-relative'>
                                                    <Form.Control type={(passwordShow2) ? 'text' : "password"} className="form-control" id="create-confirmpassword" placeholder="confirm password" {...register("confirm_password", {
                                                ...
                                                {errors.confirm_password && <small className='text-danger'>{(errors.confirm_password as any)?.message}</small>}
                                            </Col>
                                        </div>
