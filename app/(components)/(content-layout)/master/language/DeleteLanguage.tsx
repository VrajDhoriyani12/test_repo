...
const DeleteLanguage: FC<IDeleteProps> = ({ setOpenDeleteModalStatus, openDeleteModalStatus, languageID, getLanguage }) => {
  ...
  return (
    <div>
      <Modal show={openDeleteModalStatus} onHide={setOpenDeleteModalStatus}>
        ...
        <Modal.Body>
          <p className='lead'>Are you sure to remove this Language ?</p>
        </Modal.Body>
        <Modal.Footer>
